...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    deleteButtonText    : 'Delete',
    cancelButtonText    : 'Cancel',
    patientLabelTex     : 'Patient',            // MitosEHR
    categoryLabelTex    : 'Category',           // MitosEHR
    facilityLabelTex    : 'Facility',           // MitosEHR
    billingLabelTex     : 'Billing Facility',   // MitosEHR
    statusLabelTex      : 'Status',             // MitosEHR
    titleLabelText      : 'Notes',              // MitosEHR
    datesLabelText      : 'When',               // MitosEHR
    calendarLabelText   : 'Provider',           // MitosEHR
    ...
    show: function(o, animateTarget){
        ...
        if(o.data){
             ...
             * MitosEHR
             */
            fp.getComponent(this.id + '-patient_search').hide();    //MitosEHR
            fp.getComponent(this.id + '-title').show();             //MitosEHR
             ...
             * MitosEHR
             */
            fp.getComponent(this.id + '-patient_search').show();    //MitosEHR
            fp.getComponent(this.id + '-title').hide();             //MitosEHR
			//this.isAdd = true;
            this.setTitle(this.titleTextAdd);
