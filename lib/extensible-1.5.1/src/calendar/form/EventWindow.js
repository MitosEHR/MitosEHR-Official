...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    deleteButtonText    : 'Delete',
    cancelButtonText    : 'Cancel',
    patientLabelTex     : 'Patient',            // MitoEHR
    categoryLabelTex    : 'Category',           // MitoEHR
    facilityLabelTex    : 'Facility',           // MitoEHR
    billingLabelTex     : 'Billing Facility',   // MitoEHR
    statusLabelTex      : 'Status',             // MitoEHR
    titleLabelText      : 'Notes',              // MitoEHR
    datesLabelText      : 'When',               // MitoEHR
    calendarLabelText   : 'Provider',           // MitoEHR
