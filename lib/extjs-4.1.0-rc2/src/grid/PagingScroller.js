...
Ext.define('Ext.grid.PagingScroller', {
    ...
    bindView: function(view) {
        ...
        if (me.view) {
            ...
            delete me.view.refreshHeight; // Remove the injected refreshHeight implementation
        }
        ...
        me.view.refreshHeight = Ext.Function.createInterceptor(me.view.refreshHeight, me.beforeViewRefreshHeight, me);
    ...
    beforeViewRefreshHeight: function() {
        // Veto the refreshHeight if the refresh is due to a scroll.
