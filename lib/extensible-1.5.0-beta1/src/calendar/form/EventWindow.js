...
Ext.define('Extensible.calendar.form.EventWindow', {
    ...
    getFormItemConfigs: function() {
        var items = [
            this.patient_search = new Ext.create('Ext.mitos.LivePatientSearch',{
            ...
            }),
        {
            ...
            new Ext.create('Ext.mitos.CalStatusComboBox',{
