...
2) Arguments are mandatory.  For successful execution of the script, webserver_root & backup_log_dir value must match with the value in the /interface/registry.php file.
