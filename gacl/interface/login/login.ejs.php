	...
	var winLogon = new Ext.Window({
		...
		items: [{ xtype: 'box', width: 483, height: 135, autoEl: {tag: 'img', src: '../../ui_app/logon_header.png'} },{
			...
			items: [
				...
				{ xtype: 'textfield', ref: '../authUser', id: 'authUser', name: 'authUser', fieldLabel: '<?php echo htmlspecialchars( xl('Username'), ENT_NOQUOTES); ?>' },
				{ xtype: 'textfield', ref: '../clearPass', inputType: 'password', id: 'clearPass', name: 'clearPass', fieldLabel: '<?php echo htmlspecialchars( xl('Password'), ENT_NOQUOTES); ?>' },
...
<body>
<div id="oemr_logo"><img src="../../ui_app/openemr_small_logo.png" /></div>
<div id="copyright">OpenEMR v4.0 Development | <a href="javascript:void()" onClick="Ext.getCmp('winCopyright').show();" >Copyright Notice</a></div>
