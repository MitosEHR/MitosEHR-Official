...
<?php if ($_POST['embeddedScreen']) {
    ...
    $widgetButtonLabel = xl("Edit");
    $widgetButtonLink = "javascript:load_location(\"immunizations.ejs.php\")";
    $widgetButtonClass = "";
    $linkMethod = "javascript";
    $bodyClass = "summary_item small";
    $widgetAuth = true;
...
<a href="javascript:;" class="small" onclick="javascript:load_location('immunizations.ejs.php')">
    (<b><?php echo htmlspecialchars(xl('Manage'),ENT_NOQUOTES) ?></b>)
</a>
</td></tr>
<tr><td>
...
<?php
  ...
  while ($row=sqlFetchArray($result)){
    echo "&nbsp;&nbsp;";
    echo "<a class='link'";
    echo "' href='javascript:;' onclick='javascript:load_location(\"immunizations.ejs.php?mode=edit&id=".htmlspecialchars($row['id'],ENT_QUOTES) . "\")'>" .
