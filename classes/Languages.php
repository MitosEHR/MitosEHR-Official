...
class Languages {
    public function getLanguageFromTransifex($lang){
        $request = new HTTP_Request2('http://vela1606:pass@www.transifex.net/api/2/project/mitosehr/resource/All/translation/'.$lang.'/?file',
...
$LANG = ','',$r);
    ...
    public function getLanguagesFromTransifex(){
        $request = new HTTP_Request2('http://vela1606:pass@www.transifex.net/api/2/project/mitosehr/resource/All/?details',
            HTTP_Request2::METHOD_GET);
        $r = $request->send()->getBody();
