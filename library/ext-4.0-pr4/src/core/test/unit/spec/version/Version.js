describe("Ext.Version", function() {
	...
	describe("Versioning", function() {
		...
		if ('__defineSetter__' in  Function.prototype) {
			describe("deprecated Ext.version", function() {
				it("should throw an error", function() {
					expect(function() {
						var version = Ext.version;
						}).toThrow(new Error("[DEPRECATED][Ext.version] Please use Ext.getVersion(packageName) instead. For example: Ext.getVersion('core')"));
					});
				});
			}
		});
