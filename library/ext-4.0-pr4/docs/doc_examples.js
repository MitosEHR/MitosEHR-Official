Ext.reg('classCombo', function(h) {
    var curClassName = (h && typeof h.value == 'string') ? h.value : req.docClass;
...
var refreshExample = function(exampleId) {
    ...
    var url = req.baseURL + '/sencha_examples/' + exampleId;
    ...
    Ext.Ajax.request({
        ...
        success : function(response, opts) {
            ...
            window.frames['egIframe'].refreshPage();
        },
...
var refreshExampleList = function(exampleId) {
...
var showNewExampleForm = function(doc) {
    ...
    var examplesStore = new Ext.data.JsonStore({
        url: req.baseURL + '/sencha_examples',
        ...
        buttons: [
            {
                ...
                listeners: {
                    click: function() {
                        ...
                        var method = 'POST', url = req.baseURL + '/sencha_examples';
                        ...
                        Ext.Ajax.request({
                            ...
                            success : function(response, opts) {
                                ...
                                if(responseDoc.id && responseDoc.rev) {
                                    ...
                                    refreshExampleList(responseDoc.id);
        ...
        if (doc._attachments) {
            for(var a in doc._attachments) {
                ...
                rightHandSide.add({
                    xtype: 'container',
                    html: [
                        '<a href="' + req.baseURL + '/sencha_examples/'+doc._id+'/' + a + '" class="attachment '+cls+'">' + a + '</a>'
                    ].join('')
                });
            }
        }
                ...
                render: function(p) {
                    ...
                    p.getEl().on('drop', function(e){
                        ...
                        if (files.length == 1) {
                            ...
                            xhr.open('POST', req.baseURL + "/upload_screenshot", true);
