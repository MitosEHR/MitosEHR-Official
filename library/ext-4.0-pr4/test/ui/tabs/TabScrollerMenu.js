 ...
 */
Ext.define('Ext.tab.TabScrollerMenu', {
    alias: 'widget.tabscrollermenu',
    alternateClassName: 'Ext.ux.TabScrollerMenu',
    /**
    ...
    init: function(tabPanel) {
        ...
        tabPanel.on({
            render: {
                ...
                single: true,
                fn: function() {
                    var newFn = Ext.createSequence(tabPanel.createScrollers, this.createPanelsMenu, this);
    ...
    createPanelsMenu: function() {
        ...
        scrollMenu.addClsOnOver('x-tab-tabmenu-over');
        scrollMenu.on('click', this.showTabsMenu, this);

        this.scrollLeft.show = Ext.createSequence(this.scrollLeft,
        function() {
            scrollMenu.show();
        });

        this.scrollLeft.hide = Ext.createSequence(this.scrollLeft.hide,
        function() {
            scrollMenu.hide();
        });
