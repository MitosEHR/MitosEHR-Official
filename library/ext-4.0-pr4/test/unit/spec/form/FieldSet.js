describe("Ext.form.FieldSet", function() {
    ...
    describe("collapse method", function() {
        ...
        it("should set the tool type to down", function(){
            makeComponent({collapsed: true, collapsible: true});
            component.collapse();
            expect(component.legend.down('tool').type).toBe('down');
        });
    });
    ...
    describe("expand method", function() {
        ...
        it("should set the tool type to up", function(){
            makeComponent({collapsed: true, collapsible: true});
            component.expand();
            expect(component.legend.down('tool').type).toBe('up');
        });
    });
