 ...
 */
    var win = Ext.create('Ext.Window', {
        ...
        bbar: Ext.create('Ext.ux.StatusBar', {
            ...
            Ext.util.Date.format(new Date(), 'n/d/Y'), ' ', ' ', '-', {
                xtype:'splitbutton',
                text:'Status Menu',
                menuAlign: 'br-tr?',
        ...
        listeners: {
            render: {
                fn: function(){
                 ...
                 Ext.TaskMgr.start({
                     run: function(){
                         Ext.fly(clock.getEl()).update(Ext.util.Date.format(new Date(), 'g:i:s A'));
                     },
                     interval: 1000
                 });
                },
        ...
        sb.showBusy('Saving draft...');
         Ext.defer(function(){
            sb.setStatus({
                ...
                text: 'Draft auto-saved at ' + Ext.util.Date.format(new Date(), 'g:i:s A')
            });
        }, 4000);
    }, this, {buffer:1500});
