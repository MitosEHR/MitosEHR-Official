describe("Ext.Array", function() {
    ...
    describe("map", function(){
        ...
        it("should throw an exception if the function is not passed", function(){
            expect(function(){
                map([]);
            }).toThrow();
        });
    ...
    describe("filter", function(){
        ...
        it("should throw an exception if no filter function is passed", function(){
            expect(function(){
                filter([]);
            }).toThrow();
        });
    ...
    describe("each", function(){
        ...
        describe("return values", function(){
            it("should return 0 if the passed value is empty", function(){
