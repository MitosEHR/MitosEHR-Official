 ...
 * <p>It creates a specialized instance of {@link Ext.dd.DragZone DragZone} which knows how to drag out of a {@link Ext.grid.GridView GridView}
 ...
 */
Ext.define('Ext.grid.plugin.GridViewDragDrop', {
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrop) {
            me.dropZone = Ext.create('Ext.grid.GridViewDropZone', {
                view: view,
