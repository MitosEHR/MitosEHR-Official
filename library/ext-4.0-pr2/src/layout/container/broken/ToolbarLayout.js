 ...
 * Layout manager used by Ext.toolbar.Toolbar. This is highly specialised for use by Toolbars and would not
...
Ext.layout.ToolbarLayout = Ext.extend(Ext.layout.ContainerLayout, {
    ...
    onLayout : function(ct, target) {
        ...
        if (!this.leftTr) {
            ...
            target.addCls('x-toolbar-layout-ct');
            target.insertHtml('beforeEnd', Ext.util.Format.format(this.tableHTML, align));

            this.leftTr   = target.down('tr.x-toolbar-left-row', true);
            this.rightTr  = target.down('tr.x-toolbar-right-row', true);
            this.extrasTr = target.down('tr.x-toolbar-extras-row', true);
     ...
     * @param {Ext.core.Element} el The element to clean up
     */
    cleanup : function(el) {
     ...
     * @param {Ext.core.Element} target The target to add the component to
     ...
     * trigger.
     * @param {Ext.core.Element} target The Element the Toolbar is currently laid out within
     */
    ...
    initMore : function(){
        if (!this.more) {
             ...
             */
            this.more = new Ext.button.Button({
...
Ext.container.Container.LAYOUTS.toolbar = Ext.layout.ToolbarLayout;
