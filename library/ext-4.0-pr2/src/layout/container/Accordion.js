/**
 * @class Ext.layout.container.AccordionLayout
...
Ext.define('Ext.layout.container.Accordion', {
    ...
    onLayout: function() {
        ...
        // animate flag must be false during initial render phase so we don't get animations.
        if (!me.firstLayoutDone) {
            Ext.Function.defer(function() {
                me.animate = me.initialAnimate;
            }, 1);
            me.firstLayoutDone = true;
        }
    },
    ...
    onComponentExpand: function(toExpand) {
        ...
        for (; i < len; i++) {
            ...
            if (comp === toExpand && comp.collapsed) {
                ...
                comp.collapseTool.setType('expand-' + comp.getOppositeDirection(comp.expandDirection));
            }
        }
        this.layout();
        return false;
