/**
 * A small aabstract class that contains the shared behaviour for any summary
 * calculations to be used in the grid.
 * @class Ext.grid.AbstractSummaryFeature
 * @extends Ext.grid.Feature
 * @ignore
 */
Ext.define('Ext.grid.AbstractSummaryFeature', {
    ...
    */
     ...
     * @param {Ext.data.Header} column The header
