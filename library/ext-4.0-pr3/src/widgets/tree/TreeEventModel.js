...
Ext.tree.TreeEventModel.prototype = {
    ...
    getNode : function(e){
        var t = e.getTarget('.' + Ext.baseCSSPrefix + 'tree-node-el', 10);
        if(t){
    ...
    getNodeTarget : function(e){
        var t = e.getTarget('.' + Ext.baseCSSPrefix + 'tree-node-icon', 1);
        if(!t){
            t = e.getTarget('.' + Ext.baseCSSPrefix + 'tree-node-el', 6);
        }
        return t;
    },
    ...
    delegateOut : function(e, t){
        ...
        if(e.getTarget('.' + Ext.baseCSSPrefix + 'tree-ec-icon', 1)){
    ...
    delegateClick : function(e, t){
        if(this.beforeEvent(e)){
            ...
            }else if(e.getTarget('.' + Ext.baseCSSPrefix + 'tree-ec-icon', 1)){
    ...
    onIconOver : function(e, node){
        node.ui.addCls(Ext.baseCSSPrefix + 'tree-ec-over');
    },

    onIconOut : function(e, node){
        node.ui.removeCls(Ext.baseCSSPrefix + 'tree-ec-over');
    },
