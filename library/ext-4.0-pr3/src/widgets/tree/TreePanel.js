 ...
 * @xtype treepanel
 */
Ext.tree.TreePanel = Ext.extend(Ext.panel.Panel, {
    rootVisible : true,
...
a handler for this event:
    ...
    new Ext.tree.TreePanel({
        ...
        listeners: {
            contextmenu: function(node, e) {
                ...
                // it via its {@link Ext.menu.Item#parentMenu parentMenu} property.
                node.select();
    ...
    onRender : function(ct, position){
        ...
        this.el.addCls(Ext.baseCSSPrefix + 'tree');
        this.innerCt = this.body.createChild({tag:'ul',
               cls:Ext.baseCSSPrefix + 'tree-root-ct ' +
               (this.useArrows ? Ext.baseCSSPrefix + 'tree-arrows' : this.lines ? Ext.baseCSSPrefix + 'tree-lines' : Ext.baseCSSPrefix + 'tree-no-lines')});
    },
