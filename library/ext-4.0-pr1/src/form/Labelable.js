 ...
 * to let them be managed by the {@link Ext.layout.component.form.Field field layout}.</p>
 * <p>Component classes which use this mixin should use the {@link Ext.layout.component.form.Field Field layout}
...
Ext.define("Ext.form.Labelable", {
     ...
     */
    fieldBodyCls: Ext.baseCSSPrefix + 'form-item-body',
    ...
    labelableRenderTpl: [
        '<tpl if="!hideLabel">',
            ...
            '</label>',
        '</tpl>',
        '<div class="{fieldBodyCls}"<tpl if="inputId"> id="{fieldBodyCls}-{inputId}"</tpl> role="presentation">{subTplMarkup}</div>',
    ...
    getLabelableRenderData: function() {
        ...
        return Ext.copyTo(
            ...
            me,
            'hideLabel,fieldLabel,labelCls,fieldBodyCls,errorMsgCls,clearCls,labelStyle,labelSeparator',
            true
        );
    },
    ...
    renderActiveError: function() {
        ...
        if (me.rendered && !me.isDestroyed && !me.preventMark) {
            ...
            me.errorEl.dom.innerHTML = me.getActiveError();
        }
    },
