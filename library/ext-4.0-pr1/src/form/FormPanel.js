...
Ext.define('Ext.form.FormPanel', {
    ...
    initComponent: function() {
        ...
        if (this.pollForChanges) {
            this.startPolling(this.pollInterval || 500);
        }
    },
    ...
    initItems: function() {
        ...
        Ext.form.FormPanel.superclass.initItems.call(this);
    },
    ...
    onSubCmpAdded: function(parent, child) {
        ...
        Ext.form.FormPanel.superclass.onSubCmpAdded.apply(this, arguments);
    },
    ...
    disable: function(silent) {
        Ext.FormPanel.superclass.disable.call(this, silent);
    ...
    enable: function(silent) {
        Ext.FormPanel.superclass.enable.call(this, silent);
        this.form.getFields().each(function(field) {
            field.enable();
        });
    },
