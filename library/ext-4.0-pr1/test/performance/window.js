...
function addWindowPerformanceTest() {
        ...
        beforeAll : function() {
            this.previousBuffer = Ext.container.Container.bufferResize;
            Ext.container.Container.bufferResize = false;
        },

        afterAll : function() {
            Ext.container.Container.bufferResize = this.previousBuffer;
        },
