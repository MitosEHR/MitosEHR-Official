describe("Ext.tab.Tab", function() {
    ...
    describe("setting a card", function() {
        beforeEach(function() {
            ...
            spyOn(tab, 'setIconClass').andReturn(true);
        ...
        it("should set the icon class", function() {
            expect(tab.setIconClass).toHaveBeenCalledWith(card.iconCls);
        });
        ...
        describe("setting the icon class", function() {
            describe("if the tab has a specific title", function() {
                ...
                it("should retain that title", function() {
                    ...
                    expect(tab.setIconClass).toHaveBeenCalledWith('specificCls');
                });
            });
    ...
    describe("activating", function() {
        ...
        it("should add the activeCls to the element", function() {
            tab.activate();
            expect(tab.additionalCls).toContain(tab.activeCls);
        });
    ...
    describe("setting closable", function() {
        ...
        it("should add the closable class to the tab", function() {
            tab.setClosable(true);
            
            expect(tab.additionalCls).toContain(tab.closableCls);
        });
    });
