describe("AlternateClassName", function() { 
    ...
    describe("Ext.dd.DragDropMgr", function() {

        it("should have Ext.dd.DDM as the alternate class name", function() {
            expect(Ext.dd.DragDropMgr.alternateClassName).toEqual("Ext.dd.DDM");
        });

        it("should allow the use of Ext.dd.DDM", function() {
            expect(Ext.dd.DDM).toBeDefined();
        });

    });

    describe("Ext.direct.Direct", function() {

        it("should have Ext.Direct as the alternate class name", function() {
            expect(Ext.direct.Direct.alternateClassName).toEqual("Ext.Direct");
        });

        it("should allow the use of Ext.Direct", function() {
            expect(Ext.Direct).toBeDefined();
        });

    });

    describe("Ext.direct.ExceptionEvent", function() {

        it("should have Ext.Direct.ExceptionEvent as the alternate class name", function() {
            expect(Ext.direct.ExceptionEvent.prototype.alternateClassName).toEqual("Ext.Direct.ExceptionEvent");
        });

    });

    describe("Ext.direct.RemotingEvent", function() {

        it("should have Ext.Direct.RemotingEvent as the alternate class name", function() {
            expect(Ext.direct.RemotingEvent.prototype.alternateClassName).toEqual("Ext.Direct.RemotingEvent");
        });
    ...
    describe("Ext.form.Date", function() {
        ...
        it("should have Ext.form.DateField as the alternate class name", function() {
            expect(Ext.form.Date.prototype.alternateClassName).toEqual("Ext.form.DateField");
        });
    ...
    describe("Ext.form.Display", function() {
        ...
        it("should have Ext.form.DisplayField as the alternate class name", function() {
            expect(Ext.form.Display.prototype.alternateClassName).toEqual("Ext.form.DisplayField");
        });
    ...
    describe("Ext.form.FormPanel", function() {
        ...
        it("should have Ext.FormPanel as the alternate class name", function() {
            expect(Ext.form.FormPanel.prototype.alternateClassName).toEqual("Ext.FormPanel");
        });

        it("should allow the use of Ext.FormPanel", function() {
            expect(Ext.FormPanel).toBeDefined();
        });
    ...
    describe("Ext.form.Number", function() {
        ...
        it("should have Ext.form.NumberField as the alternate class name", function() {
            expect(Ext.form.Number.prototype.alternateClassName).toEqual("Ext.form.NumberField");
        });
    ...
    describe("Ext.form.Text", function() {
        ...
        it("should have Ext.form.TextField as the alternate class name", function() {
            expect(Ext.form.Text.prototype.alternateClassName).toEqual("Ext.form.TextField");
        });
    ...
    describe("Ext.form.Time", function() {
        ...
        it("should have Ext.form.TimeField as the alternate class name", function() {
            expect(Ext.form.Time.prototype.alternateClassName).toEqual("Ext.form.TimeField");
        });
    ...
    describe("Ext.toolbar.PagingToolbar", function() {

        it("should have Ext.PagingToolbar as the alternate class name", function() {
            expect(Ext.toolbar.PagingToolbar.prototype.alternateClassName).toEqual("Ext.PagingToolbar");
        });
