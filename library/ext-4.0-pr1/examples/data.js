...
Ext.samples.samplesCatalog = [
    ...
    },
    {
        ...
        samples: [
            ...
            {
                text: 'Field Layouts',
                url:  'form/field-layout.html',
                icon: 'form-field-layout.gif',
                desc: 'This example shows off all of the field types available in Ext JS, with various config options applied.',
                status: 'new'
            },
            // {
            ...
            {
                text: 'Any Component in a Form',
                url:  'form/field-container.html',
                icon: 'field-container.gif',
                desc: 'Any Component can be placed in a Form, given labels and error messages. Here we add grids and panels into a form.',
        	    status : 'new'
            }
            // {
