...
Ext.buildSettings = {"baseCSSPrefix":"x4-"};
(function(){
/**
 * Ext core methods
 * @object Ext
...
(function() {
    ...
    Ext.Class.registerPreprocessor({
        ...
        config: function(cls, data, fn) {
            ...
            if (config) {
                // Should not use a for...in loop here, these automatically generated methods
                // need their own scope so that variables don't override each others
...
(function(Class, alias) {
    ...
    var panel = Ext.widget('panel'); // Equivalent to Ext.create('widget.panel')
        ...
        reg: function(xtype, cls) {
            if (Ext.isDefined(window.console)) {
                console.warn('Using deprecated Ext.reg. Please use the alias configuration with the widget. namespace.');
            }
         ...
         * @private
         */
        preg: function(xtype, cls) {
            if (Ext.isDefined(window.console)) {
                console.warn('Using deprecated Ext.preg. Please use the alias configuration with the plugin. namespace.');
            }
            Manager.setAlias(cls, "plugin." + xtype);
        },
    ...
    Ext.override(Ext.core.Element, {
         ...
         */
            hasCls : Ext.supports.ClassList ?
                function(className) {
                    var className = className.split(spacesRe),
                        ln = className.length,
                        i = 0;
                    for (; i < ln; i++) {
...
Ext.CompositeElement = Ext.extend(Ext.CompositeElementLite, {
    ...
    */
     ...
     * <div class="mdetail-params"><ul>
     * <li><code>element</code> : <i>Ext.core.Element</i><div class="sub-desc">The element at the current <code>index</code>
