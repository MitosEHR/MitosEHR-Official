\hypertarget{class_cezpdf}{\section{\-Cezpdf \-Class \-Reference}
\label{class_cezpdf}\index{\-Cezpdf@{\-Cezpdf}}
}
...
\hypertarget{class_cezpdf_a5a537bb22cf891d5714ab2f5ddb9db30}{\index{\-Cezpdf@{\-Cezpdf}!alink@{alink}}
\index{alink@{alink}!Cezpdf@{\-Cezpdf}}
\subsubsection[{alink}]{\setlength{\rightskip}{0pt plus 5cm}{\bf alink} (
\begin{DoxyParamCaption}
\item[{\$}]{info, }
\item[{\$}]{internal = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a5a537bb22cf891d5714ab2f5ddb9db30}


\-Definition at line 1491 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                 {
  // a callback function to support the formation of clickable links within the
       document
  $lineFactor=0.05; // the thickness of the line as a proportion of the height.
       also the drop of the line.
  switch($info['status']){
    case 'start':
    case 'sol':
      ...
      $i = $info['nCallback'];
      $this->ez['links'][$i] = array('x'=>$info['x'],'y'=>$info['y'],'angle'=>
      $info['angle'],'decender'=>$info['decender'],'height'=>$info['height'],'url'=>
      $info['p']);
        $this->saveState();
        $this->setColor(0,0,1);
    ...
    case 'eol':
      ...
      // add underlining
        ...
        $dropx = cos($a)*$drop;
        $dropy = -sin($a)*$drop;
        $this->line($start['x']-$dropx,$start['y']-$dropy,$info['x']-$dropx,
      $info['y']-$dropy);
        if ($internal) {
             $this->addInternalLink($start['url'],$start['x'],$start['y']+$start
      ['decender'],$info['x'],$start['y']+$start['decender']+$start['height']);
        } else {
             $this->addLink($start['url'],$start['x'],$start['y']+$start['
      decender'],$info['x'],$start['y']+$start['decender']+$start['height']);
      }
      $this->restoreState();
      break;
...
\end{DoxyCode}
\hypertarget{class_cezpdf_aeda57292a0a29314672a7b45b093ba29}{\index{\-Cezpdf@{\-Cezpdf}!\-Cezpdf@{\-Cezpdf}}
\index{\-Cezpdf@{\-Cezpdf}!Cezpdf@{\-Cezpdf}}
\subsubsection[{\-Cezpdf}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Cezpdf} (
\begin{DoxyParamCaption}
\item[{\$}]{paper = {\ttfamily 'a4'}, }
\item[{\$}]{orientation = {\ttfamily 'portrait'}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_aeda57292a0a29314672a7b45b093ba29}


\-Definition at line 46 of file class.\-ezpdf.\-php.
       ...
       height in centimeters
        ...
        if (!is_array($paper)){
                switch (strtoupper($paper)){
                        ...
                        case 'A4': default: {$size = array(0,0,595.28,841.89); 
      break;}
...
\end{DoxyCode}
\hypertarget{class_cezpdf_aff23476735753ef4f902d338afacb9cb}{\index{\-Cezpdf@{\-Cezpdf}!exec\-Template@{exec\-Template}}
\index{exec\-Template@{exec\-Template}!Cezpdf@{\-Cezpdf}}
\subsubsection[{exec\-Template}]{\setlength{\rightskip}{0pt plus 5cm}{\bf exec\-Template} (
\begin{DoxyParamCaption}
\item[{\$}]{id, }
\item[{\$}]{data = {\ttfamily array()}, }
\item[{\$}]{options = {\ttfamily array()}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_aff23476735753ef4f902d338afacb9cb}


\-Definition at line 1478 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_af0779de4768e53437434c61e88a725d1}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Columns\-Start@{ez\-Columns\-Start}}
\index{ez\-Columns\-Start@{ez\-Columns\-Start}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Columns\-Start}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Columns\-Start} (
\begin{DoxyParamCaption}
\item[{\$}]{options = {\ttfamily array()}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_af0779de4768e53437434c61e88a725d1}


\-Definition at line 162 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // safe enough to assume the first column here, but start from the current
       y-position
  ...
  $this->ez['rightMargin']=$this->ez['pageWidth']-$this->ez['leftMargin']-
      $width;
  
}
\end{DoxyCode}
\hypertarget{class_cezpdf_a146a925a5b6775aa5a53cf80d7ee1591}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Columns\-Stop@{ez\-Columns\-Stop}}
\index{ez\-Columns\-Stop@{ez\-Columns\-Stop}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Columns\-Stop}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Columns\-Stop} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a146a925a5b6775aa5a53cf80d7ee1591}


\-Definition at line 195 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_adb2e9252531b811d249a8b6dd105ea27}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Get\-Current\-Page\-Number@{ez\-Get\-Current\-Page\-Number}}
\index{ez\-Get\-Current\-Page\-Number@{ez\-Get\-Current\-Page\-Number}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Get\-Current\-Page\-Number}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Get\-Current\-Page\-Number} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_adb2e9252531b811d249a8b6dd105ea27}


\-Definition at line 284 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_ada89a558821524c2e841fc46d312d595}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Image@{ez\-Image}}
\index{ez\-Image@{ez\-Image}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Image}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Image} (
\begin{DoxyParamCaption}
\item[{\$}]{image, }
\item[{\$}]{pad = {\ttfamily 5}, }
\item[{\$}]{width = {\ttfamily 0}, }
\item[{\$}]{resize = {\ttfamily 'full'}, }
\item[{\$}]{just = {\ttfamily 'center'}, }
\item[{\$}]{border = {\ttfamily ''}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_ada89a558821524c2e841fc46d312d595}


\-Definition at line 1319 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
        ...
        if (!(file_exists($image))) return false; //return immediately if image
       file does not exist
        ...
        if ($height > ($this->y - $this->ez['bottomMargin'] - ($pad * 2)))
        {
                ...
                {
                        $height = ($this->y - $this->ez['bottomMargin'] - ($pad
       * 2)); //shrink height
        ...
        if ($type == "jpeg"){
                $this->addJpegFromFile($image,$this->ez['leftMargin'] + $pad + 
      $offset, $this->y + $this->getFontHeight($this->ez['fontSize']) - $pad - $height
      ,$width);
        }

        if ($type == "png"){
                $this->addPngFromFile($image,$this->ez['leftMargin'] + $pad + 
      $offset, $this->y + $this->getFontHeight($this->ez['fontSize']) - $pad - $height,
      $width);
        }
        //draw border
        ...
        $this->setStrokeColor($border['color']['red'],$border['color']['green']
      ,$border['color']['blue']);
        $this->setLineStyle($border['width'],$border['cap'],$border['join']);
        $this->rectangle($this->ez['leftMargin'] + $pad + $offset, $this->y + 
      $this->getFontHeight($this->ez['fontSize']) - $pad - $height,$width,$height);
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a7321d28d6d613602e4e739fa63da6279}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Insert\-Mode@{ez\-Insert\-Mode}}
\index{ez\-Insert\-Mode@{ez\-Insert\-Mode}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Insert\-Mode}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Insert\-Mode} (
\begin{DoxyParamCaption}
\item[{\$}]{status = {\ttfamily 1}, }
\item[{\$}]{page\-Num = {\ttfamily 1}, }
\item[{\$}]{pos = {\ttfamily 'before'}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a7321d28d6d613602e4e739fa63da6279}


\-Definition at line 205 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                                         {
  // puts the document into insert mode. new pages are inserted until this is
       re-called with status=0
  // by default pages wil be inserted at the start of the document
  switch($status){
    case '1':
      if (isset($this->ezPages[$pageNum])){
        $this->ez['insertMode']=1;
        $this->ez['insertOptions']=array('id'=>$this->ezPages[$pageNum],'pos'=>
      $pos);
      }
      break;
    case '0':
...
\end{DoxyCode}
\hypertarget{class_cezpdf_adf5eb1a9dcd0d1067096273b898ec9f0}{\index{\-Cezpdf@{\-Cezpdf}!ez\-New\-Page@{ez\-New\-Page}}
\index{ez\-New\-Page@{ez\-New\-Page}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-New\-Page}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-New\-Page} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_adf5eb1a9dcd0d1067096273b898ec9f0}


\-Definition at line 222 of file class.\-ezpdf.\-php.
...
//echo $this->ez['columns']['colNum'].'<br>';
    ...
    $this->ez['leftMargin']=$this->ez['columns']['margins'][0]+($this->ez['
      columns']['colNum']-1)*($this->ez['columns']['options']['gap']+$width);
    $this->ez['rightMargin']=$this->ez['pageWidth']-$this->ez['leftMargin']-
      $width;
  }
//echo 'left='.$this->ez['leftMargin'].'  
       right='.$this->ez['rightMargin'].'<br>';
  ...
  if ($pageRequired){
    ...
    if (isset($this->ez['insertMode']) && $this->ez['insertMode']==1){
      $id = $this->ezPages[$this->ezPageCount] = $this->newPage(1,$this->ez['
      insertOptions']['id'],$this->ez['insertOptions']['pos']);
      // then manipulate the insert options so that inserted pages follow each
       other
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a55206d2bcd223a0224af03342c87a21c}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Output@{ez\-Output}}
\index{ez\-Output@{ez\-Output}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Output}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Output} (
\begin{DoxyParamCaption}
\item[{\$}]{options = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a55206d2bcd223a0224af03342c87a21c}
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a5a002788a14c3f940657f48faca602cc}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Process\-Text@{ez\-Process\-Text}}
\index{ez\-Process\-Text@{ez\-Process\-Text}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Process\-Text}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Process\-Text} (
\begin{DoxyParamCaption}
\item[{\$}]{text}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a5a002788a14c3f940657f48faca602cc}


\-Reimplemented in \hyperlink{classphpdocpdf_a5a002788a14c3f940657f48faca602cc}{phpdocpdf}.
...
\begin{DoxyCode}
                             {
  // this function will intially be used to implement underlining support, but
       could be used for a range of other
  // purposes
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a4bfefa5df6b0d2718a69b553e030507e}{\index{\-Cezpdf@{\-Cezpdf}!ez\-P\-R\-V\-Tadd\-Page\-Numbers@{ez\-P\-R\-V\-Tadd\-Page\-Numbers}}
\index{ez\-P\-R\-V\-Tadd\-Page\-Numbers@{ez\-P\-R\-V\-Tadd\-Page\-Numbers}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-P\-R\-V\-Tadd\-Page\-Numbers}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-P\-R\-V\-Tadd\-Page\-Numbers} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a4bfefa5df6b0d2718a69b553e030507e}


\-Definition at line 395 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                               {
  // this will go through the pageNumbering array and add the page numbers are
       required
    ...
    foreach($tmp1 as $i=>$tmp){
      ...
      foreach ($this->ezPages as $pageNum=>$id){
       ...
       starting on the same page
            ...
            $status=0;
          } else if ($status==1 && ($tmp[$pageNum]=='stoptn' || $tmp[$pageNum]
      =='stopn')){
            // then we are stopping page numbers
            $status=2;
          }
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a60b39bef3ca4083d0df5243518b618a9}{\index{\-Cezpdf@{\-Cezpdf}!ez\-P\-R\-V\-Tclean\-Up@{ez\-P\-R\-V\-Tclean\-Up}}
\index{ez\-P\-R\-V\-Tclean\-Up@{ez\-P\-R\-V\-Tclean\-Up}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-P\-R\-V\-Tclean\-Up}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-P\-R\-V\-Tclean\-Up} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a60b39bef3ca4083d0df5243518b618a9}


\-Definition at line 466 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_ab6fec59d56a9ed01bfa44455118f2dc5}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Prvt\-Get\-Text\-Width@{ez\-Prvt\-Get\-Text\-Width}}
\index{ez\-Prvt\-Get\-Text\-Width@{ez\-Prvt\-Get\-Text\-Width}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Prvt\-Get\-Text\-Width}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Prvt\-Get\-Text\-Width} (
\begin{DoxyParamCaption}
\item[{\$}]{size, }
\item[{\$}]{text}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_ab6fec59d56a9ed01bfa44455118f2dc5}


\-Definition at line 609 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                        {
  // will calculate the maximum width, taking into account that the text may be
       broken
  // by line breaks.
  $mx=0;
  $lines = explode("\n",$text);
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a7aaeab4da47e2bdb2ab4eb7544713bf3}{\index{\-Cezpdf@{\-Cezpdf}!ez\-P\-R\-V\-Tpage\-Number\-Search@{ez\-P\-R\-V\-Tpage\-Number\-Search}}
\index{ez\-P\-R\-V\-Tpage\-Number\-Search@{ez\-P\-R\-V\-Tpage\-Number\-Search}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-P\-R\-V\-Tpage\-Number\-Search}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-P\-R\-V\-Tpage\-Number\-Search} (
\begin{DoxyParamCaption}
\item[{\$}]{lbl, }
\item[{\&\$}]{tmp}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a7aaeab4da47e2bdb2ab4eb7544713bf3}
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a7f5b38585eb656d9824fcdbf8065dcaa}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Prvt\-Table\-Column\-Headings@{ez\-Prvt\-Table\-Column\-Headings}}
\index{ez\-Prvt\-Table\-Column\-Headings@{ez\-Prvt\-Table\-Column\-Headings}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Prvt\-Table\-Column\-Headings}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Prvt\-Table\-Column\-Headings} (
\begin{DoxyParamCaption}
\item[{\$}]{cols, }
\item[{\$}]{pos, }
\item[{\$}]{max\-Width, }
...
\item[{\$}]{size, }
\item[{\&\$}]{y, }
\item[{\$}]{options\-All = {\ttfamily array()}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a7f5b38585eb656d9824fcdbf8065dcaa}


\-Definition at line 544 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                                                               
                                    {
  // uses ezText to add the text, and returns the height taken by the largest
       heading
...
//  $y-=$gap-$decender;
  ...
  while ($ok==0){
    foreach($cols as $colName=>$colHeading){
      ...
      $this->ezText($colHeading,$size,array('aleft'=> $pos[$colName],'aright'=>
      ($maxWidth[$colName]+$pos[$colName]),'justification'=>$justification));
      $dy = $y-$this->y;
      if ($dy>$mx){
        $mx=$dy;
      }
...
//    $y -= $mx-$gap+$decender;
    ...
    // now, if this has moved to a new page, then abort the transaction, move
       to a new page, and put it there
...
\end{DoxyCode}
\hypertarget{class_cezpdf_af1e9318fd5dbb0ff229bd6e315a61abc}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Prvt\-Table\-Draw\-Lines@{ez\-Prvt\-Table\-Draw\-Lines}}
\index{ez\-Prvt\-Table\-Draw\-Lines@{ez\-Prvt\-Table\-Draw\-Lines}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Prvt\-Table\-Draw\-Lines}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Prvt\-Table\-Draw\-Lines} (
\begin{DoxyParamCaption}
\item[{\$}]{pos, }
\item[{\$}]{gap, }
\item[{\$}]{x0, }
...
\item[{\$}]{opt = {\ttfamily 1}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_af1e9318fd5dbb0ff229bd6e315a61abc}


\-Definition at line 515 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // only do the second line if it is different to the first, AND each row does
       not have
  // a line on it.
  if ($y0!=$y1 && $opt<2){
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a92b84f95898100139e83d2c2cce86b7f}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Set\-Cm\-Margins@{ez\-Set\-Cm\-Margins}}
\index{ez\-Set\-Cm\-Margins@{ez\-Set\-Cm\-Margins}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Set\-Cm\-Margins}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Set\-Cm\-Margins} (
\begin{DoxyParamCaption}
\item[{\$}]{top, }
\item[{\$}]{bottom, }
\item[{\$}]{left, }
\item[{\$}]{right}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a92b84f95898100139e83d2c2cce86b7f}


\-Definition at line 152 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_acc115b3048b5abb6f5aa0d92e6c29b04}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Set\-Dy@{ez\-Set\-Dy}}
\index{ez\-Set\-Dy@{ez\-Set\-Dy}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Set\-Dy}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Set\-Dy} (
\begin{DoxyParamCaption}
\item[{\$}]{dy, }
\item[{\$}]{mod = {\ttfamily ''}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_acc115b3048b5abb6f5aa0d92e6c29b04}
...
\begin{DoxyCode}
  ...
  // down the page
  // if $mod is set to 'makeSpace' and a new page is forced, then the pointed
       will be moved 
  // down on the new page, this will allow space to be reserved for graphics
       etc.
  $this->y += $dy;
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a0b5d4a6245514bef019775cd35ad36cf}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Set\-Margins@{ez\-Set\-Margins}}
\index{ez\-Set\-Margins@{ez\-Set\-Margins}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Set\-Margins}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Set\-Margins} (
\begin{DoxyParamCaption}
\item[{\$}]{top, }
\item[{\$}]{bottom, }
\item[{\$}]{left, }
\item[{\$}]{right}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a0b5d4a6245514bef019775cd35ad36cf}


\-Definition at line 264 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a1d6285f05e55c3b7b7a67fe14137bd94}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Set\-Y@{ez\-Set\-Y}}
\index{ez\-Set\-Y@{ez\-Set\-Y}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Set\-Y}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Set\-Y} (
\begin{DoxyParamCaption}
\item[{\$}]{y}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a1d6285f05e55c3b7b7a67fe14137bd94}


\-Definition at line 486 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a41d9b5bf85c054f88197a8ea0e721d1b}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Start\-Page\-Numbers@{ez\-Start\-Page\-Numbers}}
\index{ez\-Start\-Page\-Numbers@{ez\-Start\-Page\-Numbers}!Cezpdf@{\-Cezpdf}}
...
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a41d9b5bf85c054f88197a8ea0e721d1b}


\-Definition at line 291 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // use the given 'pattern' for display, where (PAGENUM} and {TOTALPAGENUM}
       are replaced
  // as required.
  // if $num is set, then make the first page this number, the number of total
       pages will
  // be adjusted to account for this.
  // Adjust this function so that each time you 'start' page numbers then you
       effectively start a different batch
  // return the number of the batch, so that they can be stopped in a different
       order if required.
  if (!$pos || !strlen($pos)){
    $pos='left';
  }
  ...
  $this->ez['pageNumbering'][$i][$this->ezPageCount]=array('x'=>$x,'y'=>$y,'pos
      '=>$pos,'pattern'=>$pattern,'num'=>$num,'size'=>$size);
  return $i;
}
\end{DoxyCode}
\hypertarget{class_cezpdf_a77c8952b77276a7c80bd9180c2cdd094}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Stop\-Page\-Numbers@{ez\-Stop\-Page\-Numbers}}
\index{ez\-Stop\-Page\-Numbers@{ez\-Stop\-Page\-Numbers}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Stop\-Page\-Numbers}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Stop\-Page\-Numbers} (
\begin{DoxyParamCaption}
\item[{\$}]{stop\-Total = {\ttfamily 0}, }
\item[{\$}]{next = {\ttfamily 0}, }
\item[{\$}]{i = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a77c8952b77276a7c80bd9180c2cdd094}


\-Definition at line 349 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                                     {
  // if stopTotal=1 then the totalling of pages for this number will stop too
  // if $next=1, then do this page, but not the next, else do not do this page
       either
...
\end{DoxyCode}
\hypertarget{class_cezpdf_afcca993398e4632b77ab2ea658ba7138}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Stream@{ez\-Stream}}
\index{ez\-Stream@{ez\-Stream}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Stream} (
\begin{DoxyParamCaption}
\item[{\$}]{options = {\ttfamily ''}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_afcca993398e4632b77ab2ea658ba7138}


\-Definition at line 472 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a674026b42dbc515ff4cb9072711126ea}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Table@{ez\-Table}}
\index{ez\-Table@{ez\-Table}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-Table}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-Table} (
\begin{DoxyParamCaption}
\item[{\&\$}]{data, }
\item[{\$}]{cols = {\ttfamily ''}, }
\item[{\$}]{title = {\ttfamily ''}, }
\item[{\$}]{options = {\ttfamily ''}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a674026b42dbc515ff4cb9072711126ea}


\-Definition at line 625 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // 'titleFontSize' => 12
  // 'rowGap' => 2 , the space added at the top and bottom of each row, between
  ...
  // 'xOrientation' => 'left','right','center','centre', position of the table
       w.r.t 'xPos' 
  // 'width'=> <number> which will specify the width of the table, if it turns
       out to not be this
  //    wide, then it will stretch the table to fit, if it is wider then each
       cell will be made
  //    proportionalty smaller, and the content may have to wrap.
  // 'maxWidth'=> <number> similar to 'width', but will only make table smaller
       than it wants to be
  // 'options' =>
       array(<colname>=>array('justification'=>'left','width'=>100,'link'=>linkDataName),<colname>=>....)
  //             allow the setting of other paramaters for the individual
       columns
  // 'minRowSpace'=> the minimum space between the bottom of each row and the
       bottom margin, in which a new row will be started
  //                  if it is less, then a new page would be started,
       default=-100
  // 'innerLineThickness'=>1
  // 'outerLineThickness'=>1
  // 'splitRows'=>0, 0 or 1, whether or not to allow the rows to be split
       across page boundaries
  // 'protectRows'=>number, the number of rows to hold with the heading on
       page, ie, if there less than this number of
  ...
  $defaults = array(
    ...
    ,'titleGap'=>5,'lineCol'=>array(0,0,0),'gap'=>5,'xPos'=>'centre','
      xOrientation'=>'centre'
    ,'showHeadings'=>1,'textCol'=>array(0,0,0),'width'=>0,'maxWidth'=>0,'cols'=
      >array(),'minRowSpace'=>-100,'rowGap'=>2,'colGap'=>5
    ,'innerLineThickness'=>1,'outerLineThickness'=>1,'splitRows'=>0,'
      protectRows'=>1
    );
  ...
  $middle = ($this->ez['pageWidth']-$this->ez['rightMargin'])/2+($this->ez['
      leftMargin'])/2;
  ...
  foreach($data as $row){
    foreach($cols as $colName=>$colHeading){
      $w = $this->ezPrvtGetTextWidth($options['fontSize'],(string)$row[$colName
      ])*1.01;
  ...
  foreach($maxWidth as $colName => $w){
    ...
    if (isset($options['cols'][$colName]) && isset($options['cols'][$colName]['
      width']) && $options['cols'][$colName]['width']>0){
  ...
  // if maxWidth is specified, and the table is too wide, and the width has not
       been set,
  // then set the width.
  if ($options['width']==0 && $options['maxWidth'] && ($t-$x)>$options['
      maxWidth']){
  ...
  if ($options['width'] && $adjustmentWidth>0 && $setWidth<$options['width']){
    ...
    foreach($pos as $colName=>$p){
      if (!isset($options['cols'][$last]) || !isset($options['cols'][$last]['
      width']) || $options['cols'][$last]['width']<=0){
        if (strlen($last)){
    ...
    // if needed width is negative then add it equally to each column, else get
       more tricky
    if ($presentWidth<$neededWidth){
      ...
      while ($presentWidth>$neededWidth && $cnt<100){
        ...
        // then figure out what the width of the widest columns would have to
       be to take up all the slack
        ...
        if ($newWidestWidth > $nWidest){
          ...
          // there is not space, reduce the size of the widest ones down to the
       next size down, and we
          // will go round again
          foreach($aWidest as $colName){
    ...
    foreach($pos as $colName=>$p){
      $pos[$colName]=$xq;
      if (!isset($options['cols'][$colName]) || !isset($options['cols'][
      $colName]['width']) || $options['cols'][$colName]['width']<=0){
  ...
  $this->setColor($options['textCol'][0],$options['textCol'][1],$options['
      textCol'][2]);
  $this->setStrokeColor($options['shadeCol'][0],$options['shadeCol'][1],$options
      ['shadeCol'][2]);
  ...
  if ($options['showHeadings']){
    // this function will move the start of the table to a new page if it does
       not fit on this one
    $headingHeight = $this->ezPrvtTableColumnHeadings($cols,$pos,$maxWidth,
      $height,$decender,$options['rowGap'],$options['fontSize'],$y,$options);
    $y0 = $y+$headingHeight;
    $y1 = $y;
  ...
  foreach($data as $row){
    ...
    while(!$abortTable && ($newPage || $newRow)){
      ...
      $y-=$height;
      if ($newPage || $y<$this->ez['bottomMargin'] || (isset($options['
      minRowSpace']) && $y<($this->ez['bottomMargin']+$options['minRowSpace'])) ){
        // check that enough rows are with the heading
        if ($options['protectRows']>0 && $movedOnce==0 && $cnt<=$options['
      protectRows']){
        ...
        if ($options['showLines']){
          ...
          $this->ezPrvtTableDrawLines($pos,$options['gap'],$x0,$x1,$y0,$y1,$y2,
      $options['lineCol'],$options['innerLineThickness'],$options['outerLineThickness
      '],$options['showLines']);
        }
        if ($options['shaded']){
          $this->closeObject();
        ...
        $this->ezNewPage();
        // and the margins may have changed, this is due to the possibility of
       the columns being turned on
...
//        $x1=$x1+$dm;
      ...
      'textCol'][2],1);
        ...
        $mx=0;
        if ($options['showHeadings']){
          $this->ezPrvtTableColumnHeadings($cols,$pos,$maxWidth,$height,
      $decender,$options['rowGap'],$options['fontSize'],$y,$options);
          $y1=$y;
        } else {
          $y1=$y0;
        }
      ...
      foreach($cols as $colName=>$colTitle){
        ...
        if (isset($row[$colName])){
          if (isset($options['cols'][$colName]) && isset($options['cols'][
      $colName]['link']) && strlen($options['cols'][$colName]['link'])){
            
            $lines = explode("\n",$row[$colName]);
            if (isset($row[$options['cols'][$colName]['link']]) && strlen($row[
      $options['cols'][$colName]['link']])){
              foreach($lines as $k=>$v){
                $lines[$k]='<c:alink:'.$row[$options['cols'][$colName]['link']]
      .'>'.$v.'</c:alink>';
              }
            }
          } else {
  ...
  //            $this->ezNewPage();
       ...
       columns
            ...
            if ($colNewPage){
              ...
              if (isset($options['cols'][$colName]) && isset($options['cols'][
      $colName]['justification']) ){
                $just = $options['cols'][$colName]['justification'];
              } else {
                $just='left';
              }

              $line=$this->addTextWrap($pos[$colName],$this->y,$maxWidth[
      $colName],$options['fontSize'],$line,$just);
            }
          }
        }
      ...
      if ($options['shaded'] && $cnt%2==0){
        $this->closeObject();
        $this->setColor($options['shadeCol'][0],$options['shadeCol'][1],
      $options['shadeCol'][2],1);
        $this->filledRectangle($x0-$options['gap']/2,$y+$decender+$height-$mx,
      $x1-$x0,$mx);
        $this->reopenObject($textObjectId);
      }
...
//       
       $this->line($x0-$options['gap']/2,$y+$decender+$height-$mx,$x1-$x0,$mx);
        ...
        $this->line($x0-$options['gap']/2,$y+$decender+$height,$x1-$options['
      gap']/2,$y+$decender+$height);
        $this->restoreState();
//        $this->reopenObject($textObjectId);
      }
    } // end of while 
    ...
    if ($options['splitRows']==0){
      if ( ( ($this->ezPageCount != $pageStart) || (isset($this->ez['columns'])
       && $this->ez['columns']['on']==1 && $columnStart != $this->ez['columns']['
      colNum'] ))  && $secondTurn==0){
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a70844d79499d5d80f3dfb0c0b0e9d3c2}{\index{\-Cezpdf@{\-Cezpdf}!ez\-Text@{ez\-Text}}
\index{ez\-Text@{ez\-Text}!Cezpdf@{\-Cezpdf}}
...
\item[{\$}]{test = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a70844d79499d5d80f3dfb0c0b0e9d3c2}


\-Reimplemented in \hyperlink{classphpdocpdf_a70844d79499d5d80f3dfb0c0b0e9d3c2}{phpdocpdf}.



\-Definition at line 1223 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // this will add a string of text to the document, starting at the current
       drawing
  // position.
  // it will wrap to keep within the margins, including optional offsets from
       the left
  ...
  // 'spacing' => a real number, though usually set to one of 1, 1.5, 2 (line
       spacing as used in word processing)
  ...
  if (is_array($options) && isset($options['aleft'])){
    ...
    $left = $this->ez['leftMargin'] + ((is_array($options) && isset($options['
      left']))?$options['left']:0);
  }
  if (is_array($options) && isset($options['aright'])){
    ...
    $right = $this->ez['pageWidth'] - $this->ez['rightMargin'] - ((is_array(
      $options) && isset($options['right']))?$options['right']:0);
  }
  if ($size<=0){
  ...
  // modifications to give leading and spacing based on those given by Craig
       Heydenburg 1/1/02
    ...
    while (strlen($line) || $start){
      ...
      if ($this->y < $this->ez['bottomMargin']){
        if ($test){
          ...
          $this->ezNewPage();
          // and then re-calc the left and right, in case they have changed due
       to columns
        }
      }
      if (is_array($options) && isset($options['aleft'])){
      ...
      $line=$this->addTextWrap($left,$this->y,$right-$left,$size,$line,$just,0,
      $test);
    }
  }
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a0fa7cc59cbfecab326c120b461bc8f11}{\index{\-Cezpdf@{\-Cezpdf}!ez\-What\-Page\-Number@{ez\-What\-Page\-Number}}
\index{ez\-What\-Page\-Number@{ez\-What\-Page\-Number}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ez\-What\-Page\-Number}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ez\-What\-Page\-Number} (
\begin{DoxyParamCaption}
\item[{\$}]{page\-Num, }
\item[{\$}]{i = {\ttfamily 0}}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a0fa7cc59cbfecab326c120b461bc8f11}


\-Definition at line 317 of file class.\-ezpdf.\-php.


\begin{DoxyCode}
                                        {
  // given a particular generic page number (ie, document numbered sequentially
       from beginning),
  ...
  if (!isset($this->ez['pageNumbering']))
  {
    $this->addMessage('WARNING: page numbering called for and wasn\'t started
       with ezStartPageNumbers');
    return 0;
  }
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a1b972fc41b5adf6613032c809f16930b}{\index{\-Cezpdf@{\-Cezpdf}!ilink@{ilink}}
\index{ilink@{ilink}!Cezpdf@{\-Cezpdf}}
\subsubsection[{ilink}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ilink} (
\begin{DoxyParamCaption}
\item[{\$}]{info}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a1b972fc41b5adf6613032c809f16930b}


\-Definition at line 1487 of file class.\-ezpdf.\-php.
...
\end{DoxyCode}
\hypertarget{class_cezpdf_aab2e9b4d02c4b68b676c768a12028be6}{\index{\-Cezpdf@{\-Cezpdf}!load\-Template@{load\-Template}}
\index{load\-Template@{load\-Template}!Cezpdf@{\-Cezpdf}}
\subsubsection[{load\-Template}]{\setlength{\rightskip}{0pt plus 5cm}{\bf load\-Template} (
\begin{DoxyParamCaption}
\item[{\$}]{template\-File}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_aab2e9b4d02c4b68b676c768a12028be6}


\-Definition at line 1441 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  // this function will load the requested template ($file includes full or
       relative pathname)
  // the code for the template will be modified to make it name safe, and then
       stored in 
...
\end{DoxyCode}
\hypertarget{class_cezpdf_a9ca06234fc38c2ae74a1f64d573d8c38}{\index{\-Cezpdf@{\-Cezpdf}!uline@{uline}}
\index{uline@{uline}!Cezpdf@{\-Cezpdf}}
\subsubsection[{uline}]{\setlength{\rightskip}{0pt plus 5cm}{\bf uline} (
\begin{DoxyParamCaption}
\item[{\$}]{info}
\end{DoxyParamCaption}
)}}\label{class_cezpdf_a9ca06234fc38c2ae74a1f64d573d8c38}


\-Definition at line 1534 of file class.\-ezpdf.\-php.
...
\begin{DoxyCode}
  ...
  switch($info['status']){
    ...
    case 'sol':
      ...
      $i = $info['nCallback'];
      $this->ez['links'][$i] = array('x'=>$info['x'],'y'=>$info['y'],'angle'=>
      $info['angle'],'decender'=>$info['decender'],'height'=>$info['height']);
      $this->saveState();
      $thick = $info['height']*$lineFactor;
      $this->setLineStyle($thick);
      break;
    ...
    case 'eol':
      ...
      $dropx = cos($a)*$drop;
      $dropy = -sin($a)*$drop;
      $this->line($start['x']-$dropx,$start['y']-$dropy,$info['x']-$dropx,$info
      ['y']-$dropy);
      $this->restoreState();
      break;
  }
...
\hypertarget{class_cezpdf_a4e2d45a06a93dfc4890ad13b642d5795}{\index{\-Cezpdf@{\-Cezpdf}!\$ez@{\$ez}}
\index{\$ez@{\$ez}!Cezpdf@{\-Cezpdf}}
...
\hypertarget{class_cezpdf_a7870a8b7d3cad1346107e48a87165909}{\index{\-Cezpdf@{\-Cezpdf}!\$ez\-Page\-Count@{\$ez\-Page\-Count}}
\index{\$ez\-Page\-Count@{\$ez\-Page\-Count}!Cezpdf@{\-Cezpdf}}
...
\hypertarget{class_cezpdf_a83c871beb78c15a5e93fb5c0c143d8de}{\index{\-Cezpdf@{\-Cezpdf}!\$ez\-Pages@{\$ez\-Pages}}
\index{\$ez\-Pages@{\$ez\-Pages}!Cezpdf@{\-Cezpdf}}
...
\hypertarget{class_cezpdf_a77b973d137fb33212e018b042df6e3e7}{\index{\-Cezpdf@{\-Cezpdf}!\$y@{\$y}}
\index{\$y@{\$y}!Cezpdf@{\-Cezpdf}}
