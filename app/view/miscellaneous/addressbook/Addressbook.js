...
Ext.define('Ext.mitos.view.miscellaneous.addressbook.Addressbook',{
    ...
    initComponent: function(){
        var page = this;
        var currRec;
        page.storeAddressbook = Ext.create('Ext.mitos.classes.CRUDStore',{
            fields: [
                {name: 'id',                    type: 'int'},
        ...
        // Add or Edit purpose
        // *************************************************************************************
        page.frmAddressbook = Ext.create('Ext.mitos.classes.form.FormPanel', {
            hideLabels  : true,
            items: [{
                ...
                items :[{
                    ...
                    items: [
                        { width: 100, xtype: 'displayfield', value: 'Type: '},
                          Ext.create('Ext.mitos.classes.combo.Types', {width: 130 })
                    ]
                },{
                    xtype: 'fieldcontainer',
                    defaults: { hideLabel: true },
                    ...
                    items: [
                        { width: 100, xtype: 'displayfield', value: 'First, Middle, Last: '},
                          Ext.create('Ext.mitos.classes.combo.Titles', {width: 50 }),
        ...
        // *************************************************************************************
        page.winAddressbook = Ext.create('Ext.mitos.classes.window.Window', {
            width   : 755,
