...
<!--<script type="text/javascript" src="app/view/App.js"></script>-->
    ...
    <body>
        ...
        <script type="text/javascript" src="app/view/miscellaneous/addressbook/Addressbook.js"></script>
        <script type="text/javascript" src="app/view/miscellaneous/myaccount/MyAccount.js"></script>
        <script type="text/javascript" src="app/view/miscellaneous/mysettings/MySettings.js"></script>
        <script type="text/javascript" src="app/view/miscellaneous/officenotes/OfficeNotes.js"></script>
        <script type="text/javascript" src="app/view/miscellaneous/websearch/Websearch.js"></script>
