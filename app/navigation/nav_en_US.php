...
$nav = array(
    ...
    array( 'text' => 'Patient Search',      'disabled'=> ($ACL->hasPermission('access_patient_search')  ? false:true), 'leaf' => true, 'cls' => 'file', 'iconCls' => 'searchUsers',  'id' => 'panelPatientSearch' ),
);
// *************************************************************************************
// Patient Folder
// *************************************************************************************
array_push( $nav, array( 'text' => 'Patient', 'cls' => 'folder', 'expanded' => true, 'children' =>
    array(
        ...
        array( 'text' => 'Patient Summary',  'disabled'=> ($ACL->hasPermission('access_patient_summary')? false:true), 'leaf' => true, 'cls' => 'file', 'id' => 'panelSummary' ),
        array( 'text' => 'Visits History',   'disabled'=> ($ACL->hasPermission('access_patient_visits') ? false:true), 'leaf' => true, 'cls' => 'file', 'id' => 'panelVisits' ),
...
// *************************************************************************************
if(
    $ACL->hasPermission('access_gloabal_settings') ||
    $ACL->hasPermission('access_facilities') ||
    $ACL->hasPermission('access_users') ||
    $ACL->hasPermission('access_practice') ||
    $ACL->hasPermission('access_services') ||
    $ACL->hasPermission('access_roles') ||
    $ACL->hasPermission('access_layouts') ||
    $ACL->hasPermission('access_lists') ||
    $ACL->hasPermission('access_event_log')
