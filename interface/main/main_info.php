...
if ($_SESSION['userauthorized'] && $GLOBALS['docs_see_entire_calendar']) {
    $framesrc = "calendar/calendar.ejs.php?module=PostCalendar&viewtype=".$viewtype."&func=view";
}
else if ($_SESSION['userauthorized']) {
    $framesrc = "calendar/calendar.ejs.php?module=PostCalendar&viewtype=".$viewtype."&func=view&".$pcuStr;
}
else {
    $framesrc = "calendar/calendar.ejs.php?module=PostCalendar&func=view&viewtype=".$viewtype;
}
?>
