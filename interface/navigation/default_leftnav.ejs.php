...
if (acl_check('admin', 'users')) $buff .= '		{"text":"' . xl('Facilities') . '", "pos":"top", "leaf":true, "cls":"file", "id":"administration/facilities/facilities.ejs.php"},'.chr(13);
...
$buff .= '		{"text":"' . xl('Address Book') . '", "pos":"top", "leaf":true, "cls":"file", "id":"' . $primary_docs['adb'][2] . '"},'.chr(13);
