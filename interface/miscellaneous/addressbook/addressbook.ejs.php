...
var addressBookRecord = Ext.data.Record.create([
  ...
  {name: 'city',                  type: 'string',           mapping: 'name'},
  {name: 'state',                 type: 'string',           mapping: 'name'},
  {name: 'zip',                   type: 'string',           mapping: 'name'},
  {name: 'street2',               type: 'string',           mapping: 'name'},
  {name: 'streetb2',              type: 'string',           mapping: 'name'},
  {name: 'city2',                 type: 'string',           mapping: 'name'},
  {name: 'state2',                type: 'string',           mapping: 'name'},
  {name: 'zip2',                  type: 'string',           mapping: 'name'},
  {name: 'phone',                 type: 'string',           mapping: 'name'},
  {name: 'fax',                   type: 'string',           mapping: 'name'},
  {name: 'phonew1',               type: 'string',           mapping: 'name'},
  {name: 'phonew2',               type: 'string',           mapping: 'name'},
  {name: 'phonecell',             type: 'string',           mapping: 'name'},
  {name: 'notes',                 type: 'string',           mapping: 'name'},
  {name: 'cal_ui',                type: 'string',           mapping: 'name'},
  {name: 'taxonomy',              type: 'string',           mapping: 'name'},
  {name: 'ssi_relayhealth',       type: 'string',           mapping: 'name'},
  {name: 'calendar',              type: 'int',              mapping: 'name'},
  {name: 'abook_type',            type: 'string',           mapping: 'name'},
  {name: 'pwd_expiration_date',   type: 'string',           mapping: 'name'},
  {name: 'pwd_history1',          type: 'string',           mapping: 'name'},
  {name: 'pwd_history2',          type: 'string',           mapping: 'name'},
  {name: 'default_warehouse',     type: 'string',           mapping: 'name'},
  {name: 'irnpool',               type: 'string',           mapping: 'name'},
  {name: 'ab_name',               type: 'string',           mapping: 'name'}
